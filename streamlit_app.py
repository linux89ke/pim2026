...
(function() {
  ...
  target.addEventListener("message", function(e) {
    if (!e.data || e.data.type !== "jtGrid" || e.data.action !== "reject") return;
    ...
    setter.call(bridge, JSON.stringify({action: e.data.action, payload: e.data.payload}));
